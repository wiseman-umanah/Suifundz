...
import defiImage from "../assets/defiImage.jpg";
...
export default function Home() {
  return (
    <div
      ...
      style={{ backgroundImage: `url(${defiImage})` }}
    >
      {/* Overlay */}
      ...
      <div className="relative z-10 p-4">
        ...
        <p className="text-lg md:text-xl lg:text-2xl mb-6 mx-auto max-w-3xl">
          Bridging the gap between Web2 and Web3 by allowing users to convert
          money from crypto to USDT and to local currency, and then send to
          their bank account.
        </p>
        <NavLink
          to="/wallet"
          className="bg-transparent border-white border-2 text-white font-semibold py-2 px-4 rounded-full"
        >
          Get Started →
        </NavLink>
      </div>
